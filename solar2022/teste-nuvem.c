...
{
	int socket_local;			/* Socket usado nesta m�quina */
...
{
	struct sockaddr_in servidor; 	/* Endere�o completo do servidor e do cliente */
...
int main(int argc, char *argv[])
{
	...
	do{
		...
		printf("Recebido: '%s', vai responder 'qwerty %d'\n", buffer, ++conta);
		sprintf( buffer, "qwerty %d", conta);
